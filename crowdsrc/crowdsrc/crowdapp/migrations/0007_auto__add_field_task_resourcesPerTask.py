...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.resourcesPerTask'
        db.add_column(u'crowdapp_task', 'resourcesPerTask',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.resourcesPerTask'
        db.delete_column(u'crowdapp_task', 'resourcesPerTask')
    ...
    models = {
        ...
        u'crowdapp.task': {
            ...
            'cost': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 23, 0, 0)'}),
            ...
            'resourcesPerTask': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
