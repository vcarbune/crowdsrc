...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskInputValue.solution'
        db.add_column(u'crowdapp_taskinputvalue', 'solution',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crowdapp.Solution']),
                      keep_default=False)

        # Deleting field 'Task.html'
        db.delete_column(u'crowdapp_task', 'html')

        # Adding field 'Task.content'
        db.add_column(u'crowdapp_task', 'content',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskInputValue.solution'
        db.delete_column(u'crowdapp_taskinputvalue', 'solution_id')

        # Adding field 'Task.html'
        db.add_column(u'crowdapp_task', 'html',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Task.content'
        db.delete_column(u'crowdapp_task', 'content')
    ...
    models = {
        ...
        u'crowdapp.task': {
            ...
            'cost': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 21, 0, 0)'}),
