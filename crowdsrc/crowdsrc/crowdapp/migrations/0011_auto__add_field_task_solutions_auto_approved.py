...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.solutions_auto_approved'
        db.add_column(u'crowdapp_task', 'solutions_auto_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.solutions_auto_approved'
        db.delete_column(u'crowdapp_task', 'solutions_auto_approved')
    ...
    models = {
        ...
        u'crowdapp.task': {
            ...
            'cost': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 30, 0, 0)'}),
            ...
            'solutions_auto_approved': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
