...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('crowdapp_solution', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crowdapp.Task']),
                      keep_default=False)


        # Changing field 'Solution.access_path'
        db.alter_column('crowdapp_solution', 'access_path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crowdapp.AccessPath'], null=True))

    def backwards(self, orm):
        # Deleting field 'Solution.task'
        db.delete_column('crowdapp_solution', 'task_id')


        # Changing field 'Solution.access_path'
        db.alter_column('crowdapp_solution', 'access_path_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crowdapp.AccessPath']))
