...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'crowdapp_resource', 'name')

        # Deleting field 'UserProfile.is_taskcreator'
        db.delete_column(u'crowdapp_userprofile', 'is_taskcreator')


    def backwards(self, orm):
        # Adding field 'Resource.name'
        db.add_column(u'crowdapp_resource', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.is_taskcreator'
        db.add_column(u'crowdapp_userprofile', 'is_taskcreator',
    ...
    models = {
        ...
        u'crowdapp.task': {
            ...
            'cost': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 25, 0, 0)'}),
