...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crowdapp_task', 'created_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Task.created_at'
        db.alter_column(u'crowdapp_task', 'created_at', self.gf('django.db.models.fields.DateField')())
