...
# Paths
PROJECT_ROOT = WORKSPACE_ROOT + 'crowdsrc/'
...
DATABASES = {
    'default': {
        ...
        'USER': 'crowd',                      # Not used with sqlite3.
        'PASSWORD': 'crowd',                  # Not used with sqlite3.
...
SECRET_KEY = '4%ry^di2w$^#sp)_26^p_a54gr15ulp4sju4o!rvivw^20nok7'
